/*
 * Proyecto: Api-Dygy
 * Fichero: Consulta_Cartera_Grupos_Pdf.prg
 * Descripci�n:
 * Autor:
 * Fecha: 30/01/2023
 */
...
FUNCTION consulta_cartera_grupos_pdf()

   LOCAL hpaso:={=>}, hestado:= {=>}, hadoerror:= {=>}
   LOCAL hrenglon:= {=>}, hpunto:= {=>}, ohoja, nrenglon, nid_factura

   LogFile(DToC(Date())+" "+Time()+"   ******** en API-DYGY Inicializando funcion consulta_cartera_grupos_pdf   "+Str(seconds(),12,4))
   ...
   *=================================================================================================================================================
   ...
   if appdata:hreporte["ctipo_tablero"]="1"
      ...
      genera_pdf_cartera_grupos_analiticos()
   ...
   if appdata:hreporte["ctipo_tablero"]="2"
      ...
      genera_pdf_cartera_grupos_auxiliar()
   ...
   if appdata:hreporte["ctipo_tablero"]="3"
      ...
      genera_pdf_cartera_grupos_antiguedad()
...
FUNCTION genera_pdf_cartera_grupos_antiguedad()

   LOCAL hpaso:={=>}, hestado:= {=>}, hadoerror:= {=>}, hrenglon:= {=>}
   LOCAL hcolumna:= {=>}, ohoja, nrenglon
   ...
   *=================================================================================================================================================
   ...
   hadoerror["ctitulo_mensaje"] := "Oops...   El sistema no puede obtener datos de antiguedad de grupo"
   ...
   for each hrenglon in hpaso["adant"]
      ...
      if appdata:himpresion["ltitulos"]
         ...
         escribe_dato({"ncolumna"      => 1.0 , ;
                       "ctexto"        => "REPORTE" , ;
                       "cdato"         => "ANTIGUEDAD DE SALDOS", ;
                       "nfuente_dato"  => 9, ;
                       "lnegrita_dato" => .f.}, appdata:himpresion)

         escribe_dato({"ncolumna"      => 7.0 , ;
                       "ctexto"        => "GRUPO" , ;
                       "cdato"         => appdata:hreporte["cnombre_grupo"], ;
                       "nfuente_dato"  => 9, ;
                       "lnegrita_dato" => .f.}, appdata:himpresion)
         ...
         escribe_dato({"ncolumna"      => 1.0     , ;
                       "ctexto"        => "FECHA" , ;
                       "cdato"         => "AL: " + fectal(appdata:hreporte["cfecha_final"]), ;
                       "nfuente_dato"  => 9, ;
                       "lnegrita_dato" => .f.}, appdata:himpresion)
      ...
      do case
         ...
         case hrenglon["clase"]="02"

            *=================================================================================================================================================
            * RENGLON DE NOMBRE DE GRUPO, NO SE OCUPA EN ESTE FORMATO
            *=================================================================================================================================================

            loop

         case hrenglon["clase"]="04"
         ...
         case hrenglon["clase"]="12"
            ...
            *=================================================================================================================================================
            ...
            appdata:himpresion["acolus"][3]["dato"]  := "TOTAL CLIENTE"
            ...
            appdata:himpresion["nrenglon"] += 0.25

         case hrenglon["clase"]="14"

            *=================================================================================================================================================
            * TOTAL GRUPO, EN ESTE CASI SERA EL TOTAL GENERAL
            *=================================================================================================================================================
   ...
   *borra_temporales()
   ...
   LogFile(DToC(Date())+" "+Time()+"   ******** Finalizando y saliendo de funcion genera_pdf_cartera_grupos_antiguedad   "+Str(seconds(),12,4))

RETURN NIL

//------------------------------------------------------------------------------

FUNCTION genera_pdf_cartera_grupos_auxiliar()
   ...
   *=================================================================================================================================================================
   ...
   for each hrenglon in hpaso["adaux"]

      *=================================================================================================================================================================
      * CODIGO "01" - NOMBRE DEL GRUPO Y CODIGO "14" - TOTAL GENERAL PARA ESTE DOCUMENTO NO SE NECESITAN
      *=================================================================================================================================================================

      if hrenglon["clase"]="01" .or. hrenglon["clase"]="14"
         loop
      endif
      ...
      do case
         ...
         case hrenglon["clase"]="03"

            *=================================================================================================================================================
            * RENGLON CON NOMBRE, TAMBIEN AQUI VIENE EL SALDO ANTERIOR
            *=================================================================================================================================================
         ...
         case hrenglon["clase"]="09" .or. hrenglon["clase"]="10"
            ...
            *=================================================================================================================================================
            ...
            hpaso["nanterior_grupo"]   += hpaso["nanterior_cliente"]
         ...
         case hrenglon["clase"]="12"
            ...
            *=================================================================================================================================================
            ...
            appdata:himpresion["acolus"][1]["dato"]  := ""
            appdata:himpresion["acolus"][2]["dato"]  := ""
            appdata:himpresion["acolus"][3]["dato"]  := "TOTAL GRUPO"
      ...
      *=================================================================================================================================================
      ...
      if hrenglon:__enumindex < Len(hpaso["adaux"])
         if hpaso["adaux"][hrenglon:__enumindex +1]["clase"] = "09"
            loop
         endif
      endif
...
FUNCTION genera_pdf_cartera_grupos_analiticos()
   ...
   *=================================================================================================================================================================
   ...
   for each hrenglon in hpaso["adana"]
      ...
      *=================================================================================================================================================================
      * RENGLON TIPO "01" CON NOMBRE DE GRUPO Y RENGLON TIPO "14" TOTAL GENERAL EN ESTE FORMATO NO SON NECESARIOS
      *=================================================================================================================================================================
      ...
      do case
         ...
         case hrenglon["clase"]="12"
            ...
            *=================================================================================================================================================
            ...
            appdata:himpresion["acolus"][1]["dato"]  := ""
            appdata:himpresion["acolus"][2]["dato"]  := "TOTAL GRUPO"
